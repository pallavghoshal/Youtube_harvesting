    ...
    with tab2:
        ...
        def insert_channels():
            ...
            if existing_record:
                ...
                # cursor.execute("UPDATE yt_channel SET ... WHERE channel_id = %s", (i['channel_id'],))
                pass
            else:
        ...
        def insert_into_playlist():
            ...
            query = """INSERT IGNORE INTO yt_playlist VALUES(%s,%s,%s)"""
            for j in col.find():
                j.pop("_id")
        ...
        def insert_into_comments():
            ...
            query2 = """INSERT IGNORE INTO yt_comment VALUES(%s,%s,%s,%s,%s)"""
